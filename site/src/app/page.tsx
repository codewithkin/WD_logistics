...
const TITLE = "WD Logistics | Trucking & Freight Logistics Company in Mutare, Zimbabwe";
const DESCRIPTION =
  "WD Logistics (Pvt) Ltd runs short and long-distance road freight from our Mutare base across Zimbabwe and the SADC region — full loads, part loads and bulk haulage on satellite-tracked trucks. Get a quote on WhatsApp today.";
...
const STRUCTURED_DATA = {
  ...
  image: `${SITE_URL}/images/fleet-lineup-yard.jpg`,
