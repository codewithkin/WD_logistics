...
/**
 * Send credentials to a newly invited user
 */
export async function sendUserCredentials(email: string, password: string, role: string) {
...
You have been added as a ${roleDisplay}. Here are your login credentials:
...
<body>
  <div class="container">
    ...
    <div class="content">
      <p>Hello,</p>
      <p>You have been added as a <strong>${roleDisplay}</strong> to the WD Logistics platform.</p>
