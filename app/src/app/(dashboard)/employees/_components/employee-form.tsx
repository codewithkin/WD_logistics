...
import { EmployeeStatus, EMPLOYEE_STATUS_LABELS } from "@/lib/types";
    ...
    const onSubmit = async (data: EmployeeFormData) => {
        ...
        try {
            ...
            const result = isEditing
                ? await updateEmployee(employee.id, submitData, approvalReason)
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input placeholder="e.g., Truck Driver" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                ...
                <div className={cn("grid gap-4 sm:grid-cols-2", isEditing && "lg:grid-cols-3")}>
                    {isEditing && (
                        <FormField
                            control={form.control}
                            name="status"
